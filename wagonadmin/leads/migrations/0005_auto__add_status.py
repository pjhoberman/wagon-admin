...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Status'
        db.create_table(u'leads_status', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal(u'leads', ['Status'])

        # Adding M2M table for field status on 'Lead'
        db.create_table(u'leads_lead_status', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lead', models.ForeignKey(orm[u'leads.lead'], null=False)),
            ('status', models.ForeignKey(orm[u'leads.status'], null=False))
        ))
        db.create_unique(u'leads_lead_status', ['lead_id', 'status_id'])


    def backwards(self, orm):
        # Deleting model 'Status'
        db.delete_table(u'leads_status')

        # Removing M2M table for field status on 'Lead'
        db.delete_table('leads_lead_status')
    ...
    models = {
        ...
        u'leads.lead': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lead_category': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['leads.Category']", 'null': 'True', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['leads.Status']", 'null': 'True', 'blank': 'True'}),
