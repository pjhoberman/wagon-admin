...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'leads_lead', (
            ...
            ('entered_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lead_entered_by', to=orm['auth.User'])),
            ('assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lead_assigned_to', to=orm['auth.User'])),
        ))
    ...
    models = {
        ...
        u'leads.lead': {
            ...
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lead_assigned_to'", 'to': u"orm['auth.User']"}),
            ...
            'entered_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lead_entered_by'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
